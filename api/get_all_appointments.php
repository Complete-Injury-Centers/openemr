...
echo json_encode( fetchAppointments($payload["from"], $payload["to"]));
...
function fetchAppointments($from_date, $to_date, $patient_id = null, $facility_id = null)
{
    ...
    "(e.pc_eventDate >= '".$conn->real_escape_string($from_date)."' AND e.pc_eventDate <= '".$conn->real_escape_string($to_date)."'))";
